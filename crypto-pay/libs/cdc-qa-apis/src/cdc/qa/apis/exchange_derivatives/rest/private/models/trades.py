...
class GetTradesRequestBody(DerivativesSignedRequest):
...
class GetTransactionsRequestParams(FrozenBaseModel):
    instrument_name: Optional[str] = Field(default=None, description="e.g. ETH_CRO, BTC_USDT. Omit for 'all'")
...
class GetTransactionsRequestBody(DerivativesSignedRequest):
...
class GetTransactionsResponse(DerivativesResponse):
...
class ConvertCollateralRequestParams(FrozenBaseModel):
...
class ConvertCollateralRequestBody(DerivativesSignedRequest):
    method: str = "private/convert-collateral"
    params: ConvertCollateralRequestParams = Field()


class ConvertCollateralResponse(DerivativesResponse):
    method: str
