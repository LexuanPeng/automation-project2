...
class OTCService(ExchangeRestService):
    def get_otc_user(self) -> GetOTCUserResponse:
    ...
    def accept_quote(self, quote_id: str, direction: str = None) -> AcceptQuoteResponse:
        ...
        payload = AcceptQuoteRequestBody(
            params=AcceptQuoteRequestParams(quote_id=quote_id, direction=direction),
            api_key=self.api_key,
            secret_key=self.secret_key,
