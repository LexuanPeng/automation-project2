...
class ResponseCodes(IntEnum):
    ...
    INVALID_LIST_ID = 239
    FROM_AND_TO_MUST_BE_DIFFERENT_ACCOUNTS = 240
    HAS_OPEN_ORDER_OR_POSITION = 242
...
class SystemLabel(Enum):
    ONEEX = "ONEEX"
    FORMER_SPOT = "FORMER_SPOT"
    FORMER_MARGIN = "FORMER_MARGIN"
    FORMER_DERIVATIVES = "FORMER_DERIVATIVES"


class ExchangeRequestParams(FrozenBaseModel):
    """Shared request params schema.
    ...
    system_label: Optional[str] = Field(default=None, description="wallet system label")
